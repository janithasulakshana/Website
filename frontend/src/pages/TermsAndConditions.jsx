  ...
  return (
    <div style={{ backgroundColor: "#ffffff", color: "#333333", minHeight: "100vh", padding: "40px 20px" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <h1 style={{ fontSize: "48px", marginBottom: "10px" }}>Terms and Conditions</h1>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "16px" }}>
          ...
          <section style={{ marginBottom: "30px" }}>
            <h2 style={{ color: "#007bff", fontSize: "24px", marginBottom: "15px" }}>1. Agreement to Terms</h2>
            <p>
          ...
          <section style={{ marginBottom: "30px" }}>
            <h2 style={{ color: "#007bff", fontSize: "24px", marginBottom: "15px" }}>8. Booking and Cancellation Policy</h2>
            <ul style={{ paddingLeft: "25px" }}>
              <li style={{ marginBottom: "10px" }}>Bookings can be cancelled up to 24 hours before the tour date for a full refund</li>
              <li style={{ marginBottom: "10px" }}>Cancellations made within 24 hours will incur a 50% cancellation fee</li>
              <li style={{ marginBottom: "10px" }}>No-show bookings will be charged in full</li>
              <li style={{ marginBottom: "10px" }}>In case of extreme weather, alternative dates will be offered</li>
            </ul>
          </section>
          ...
          <section style={{ marginBottom: "30px" }}>
            ...
            <p>
              If you have any questions about these Terms and Conditions, please contact us at: letsgocolombotoursbyj@gmail.com or call +94 70 309 7737
            </p>
          </section>
